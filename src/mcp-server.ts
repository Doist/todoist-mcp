...
- **quick-add-task**: Create a **single** task from one natural-language string (Todoist Quick Add syntax). Prefer this when relaying user-typed NL — especially with inline reminders (\`!30m\`). Use **add-tasks** for bulk, deadlines, durations, or when you have IDs.
